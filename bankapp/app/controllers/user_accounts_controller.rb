class UserAccountsController < ApplicationController
  ...
  def create
    ...
    UserAccount.calculate_interest @user_account
  ...
  private
    ...
    def user_account_params
      params.require(:user_account).permit(:debit_account_no, :amount_deposit, :deposit_type, :tenure_of_deposit, :pan_no, :maturity_proceeds, :mobile_no, :email)
    end
end
